! function(e) {
    ...
    }, e("[data-bg-src]").vsBgSetup(), e("[data-mask-src]").vsMaskSetup(), e(".vs-carousel").each((function() {
        var t = e(this);
    ...
    }, e("[data-slick-next]").slickGoNext(), e("[data-slick-prev]").slickGoPrev();
    ...
    function p(t, s, a, n, o) {
        var i, r = e(t).serialize();
        i = function(t, s, a, n) {
            var o, i = !0;

            function r(t) {
                t = t.split(",");
                for (var s = 0; s < t.length; s++) o = n + " " + t[s], e(o).val() ? (e(o).removeClass(a), i = !0) : (e(o).addClass(a), i = !1)
            }
            r(t), e(s).val() && e(s).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (e(s).removeClass(a), i = !0) : (e(s).addClass(a), i = !1);
            return i
        }(s, a, n, t), i && jQuery.ajax({
            url: e(t).attr("action"),
            data: r,
            type: "POST"
        }).done((function(s) {
            o.removeClass("error"), o.addClass("success"), o.text(s), e(t + ' input:not([type="submit"]),' + t + " textarea").val("")
        })).fail((function(e) {
            o.removeClass("success"), o.addClass("error"), "" !== e.responseText ? o.html(e.responseText) : o.html("Oops! An error occured and your message could not be sent.")
        }))
    }
    e(i).on("submit", (function(e) {
            e.preventDefault(), p(i, '[name="name"],[name="email"],[name="subject"],[name="message"]', l, r, c)
        })), e(d).on("submit", (function(e) {
            e.preventDefault(), p(d, '[name="name"],[name="email"],[name="subject"],[name="number"],[name="date"]', l, r, u)
        ...
        function(t, s, a, n) {
        ...
        }(".popup-search-box", ".searchBoxTggler", ".searchClose", "show"), e("#ship-to-different-address-checkbox").on("change", (function() {
        ...
        }, e(".shape-mockup") && e(".shape-mockup").shapeMockup(), e("#slider-range").slider({
            range: !0,
            min: 40,
            max: 300,
            values: [60, 570],
        ...
        }), e("#minAmount").text("$" + e("#slider-range").slider("values", 0)), e("#maxAmount").text("$" + e("#slider-range").slider("values", 1)), new WOW({
            boxClass: "wow",
            ...
            resetAnimation: !1
        }).init(), e(".vs-hero-carousel").each((function() {
            var t = e(this);
            ...
            var a = ".thumb",
                n = "data-slide-go";
            t.on("sliderDidLoad", (function(s, o) {
                var i = o.slides.current.index,
                    r = 1;
                t.find(a).each((function() {
                    e(this).attr(n, r), r++, e(this).on("click", (function(s) {
                        s.preventDefault();
                        var a = e(this).attr(n);
